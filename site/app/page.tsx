...
const days: Day[] = [
  ...
  { date:"10.05 · 周一", city:"普吉", title:"老城、寺庙与南端日落", lead:"4人包车走一条完整的本岛路线，上午慢出发，傍晚把神仙半岛作为全日重点。", pace:"适中", rule:"日落受天气影响；大雨时缩短南部路线，不冒险赶观景点。", events:[
    ...
    {time:"17:15",tag:"日落",title:"神仙半岛",note:"争取17:30前到达；天气和体力允许时顺路看风车观景点。"},
    {time:"19:30",tag:"晚餐",title:"卡伦 / 卡塔就近用餐",note:"全天包车结束后直接回酒店区域，不再跨区逛夜市。"}]},
  { date:"10.06 · 周二", city:"普吉", title:"把整天留给海，也保留退路", lead:"首选皮皮岛、玛雅湾与竹子岛一日团；如更看重山海景观，可换攀牙湾与洞穴独木舟。", pace:"早出晚归", rule:"前一晚复核雷暴、风浪、停航与退款规则；妈妈可留在卡伦，不强制全员出海。", events:[
    {time:"前晚确认",tag:"二选一",title:"锁定正规跳岛团",note:"确认酒店接送、保险、午餐、登岛费、天气取消与退款规则。"},
    {time:"07:00—17:00",tag:"A 组",title:"皮皮岛＋玛雅湾＋竹子岛",note:"经典海岛线，行程较长；不适合晕船或不愿乘快艇的人。"},
    {time:"同步",tag:"B 组",title:"卡伦海滩＋酒店休息",note:"不出海成员保留房卡、现金和叫车方式，晚餐地点提前约定。"},
    {time:"18:30",tag:"恢复",title:"晚餐或泰式按摩",note:"视体力决定，不预约高强度项目；随后整理次日转场行李。"}]},
  { date:"10.07 · 周三", city:"曼谷", title:"海滩收尾，转场去曼谷", lead:"上午只在卡伦附近活动，搭乘中午前后 HKT → BKK 直飞；晚上用美食街完成城市开场。", pace:"交通日", events:[
    {time:"08:30",tag:"海滩",title:"卡伦慢上午",note:"海边散步或看卡伦观景台，具体取决于航班时间和天气。"},
    {time:"起飞前3小时",tag:"退房",title:"卡伦 → 普吉机场",note:"提前预约送机；雨季道路缓冲不压缩。"},
    ...
    {time:"18:30",tag:"美食",title:"Banthat Thong 美食街",note:"避开18:00—20:00排队高峰；Jeh O Chula等热门店不作为必须打卡。"}]},
  { date:"10.08 · 周四", city:"曼谷", title:"射击体验与平价火锅", lead:"上午安排全程有教练的正规射击体验，晚上去MBK附近吃 Suki Teenoi；中间保留休息。", pace:"适中", rule:"必须提前确认营业、年龄限制、证件要求、保险与教练陪同；任何人都可不参加。", events:[
    {time:"10:30",tag:"需预订",title:"正规射击场体验",note:"优先选择交通可控、可确认开放状态的场地；现场严格遵守教练指令。"},
    {time:"13:30",tag:"休息",title:"返回市区午休",note:"不在射击后连续叠加室外项目，给全员完整恢复时间。"},
    {time:"17:30",tag:"商圈",title:"MBK Center 随意逛",note:"从National Stadium站步行衔接，购物和代购单独记账。"},
    {time:"20:00",tag:"晚餐",title:"Suki Teenoi 自助小火锅",note:"优先MBK分店并避开饭点；若排队过长，直接换附近餐厅。"}]},
  { date:"10.09 · 周五", city:"曼谷", title:"商场、河岸与城市夜景", lead:"周五不硬逛只开放部分摊位的乍都乍，改用有空调的商圈与河岸路线。", pace:"轻松", events:[
    {time:"10:30",tag:"购物",title:"暹罗商圈",note:"Siam Paragon、Siam Center、Siam Discovery按兴趣选择，不必全部逛完。"},
...
const tasks = [
  ...
  ["sim","出发前","准备4人流量方案","比较eSIM、实体卡和国际漫游，保存离线订单与酒店地址。"],
  ["weather","10月5日晚","决定10月6日出海方案","海况不安全即取消出海，不以已付款为理由冒险。"],
